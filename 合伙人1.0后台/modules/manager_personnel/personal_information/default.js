...
exports.ready = (req, res, that) => {
    ...
    db.query("select a.openid_jhkj,b.amount,b.consume,b.blocked_assets,a.headimgurl,b.username,b.realname,b.mobile,b.company_name,b.total_assets from `db_people` a inner join `db_manager` b on a.manager_id = b.id and a.openid = b.openid where b.id = ? and a.openid = ? ", [body.manager_id,body.open_id] , function(err, row, fields) {
    // 数据获取失败
        if (err) {
            db.release();// 释放资源
            conn.end(); // 结束当前数据库链接
