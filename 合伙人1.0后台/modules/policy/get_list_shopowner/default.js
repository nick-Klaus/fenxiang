...
exports.ready = (req, res, that) => {
    ...
    that.connect((err, db,conn) => {
        ...
        //记录查询日志
            ...
            db.query("select count(1) num from `db_policy` a where a.shop_id = ?     order by a.id desc", [body.shopowner_id], function(err, row, fields) {
                ...
                var sql = "select * from `db_policy` a where a.shop_id = ?  order by a.id desc limit  " + _currentpage + "," + _pagesize;
