...
exports.ready = (req, res, that) => {
    ...
    db.query("select headimgurl,manager_id,shopowner_id,openid,nickname,sex,realname,mobile,amount,consume,token,user_level from `db_people` where id = ?", body.id , function(err, row, fields) {
    // 数据获取失败
        if (err) {
